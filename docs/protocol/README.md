...
**Start here: [`first-24-hours.md`](first-24-hours.md).**

This is the part of the project that works right now, on paper, with no account, no app, no
internet, and no Supabase project. It is deliberately written to stand alone, because it is the
part most likely to be useful to someone before any software ships.

## The documents

| Document | When |
|---|---|
| [**first-24-hours.md**](first-24-hours.md) | **Read this first.** The whole sequence, in order. |
| [search-grid.md](search-grid.md) | Day 1 onward. Making sure you actually searched a place. |
| [neighbor-canvass.md](neighbor-canvass.md) | Day 1 daylight. The 11% found in someone else's building. |
| [feeding-station-and-camera.md](feeding-station-and-camera.md) | Night 1. What works while you sleep. |
| [approach-and-recovery.md](approach-and-recovery.md) | The moment you see it. Read before you need it. |
| [humane-trapping.md](humane-trapping.md) | When it is visiting but will not approach. |

## Scope

Written for **indoor-only cats that escaped outdoors**, in a suburban or urban residential
...
Dogs behave differently again, in almost every respect. Do not use this for a dog.

## What this is based on

Every factual claim traces to [`../evidence.md`](../evidence.md), principally the Huang et al.
